...
INSERT INTO "new_ExamWindow" ("activa", "createdAt", "cupoMaximo", "duracion", "estado", "examId", "fechaInicio", "id", "modalidad", "notas", "sinTiempo", "updatedAt") SELECT "activa", "createdAt", "cupoMaximo", "duracion", "estado", "examId", "fechaInicio", "id", "modalidad", "notas", "sinTiempo", "updatedAt" FROM "ExamWindow";
